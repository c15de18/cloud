...
def evaluate_employee(communication, punctuality, productivity, teamwork):
    ...
    if productivity.lower() == 'high':
        score += 3
    elif productivity.lower() == 'medium':
        score += 2
    elif productivity.lower() == 'low':
        score += 1
...
punct = input("Punctuality (Always on time/Usually on time/Sometimes late): ")
